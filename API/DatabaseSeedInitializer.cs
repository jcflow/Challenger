    ...
    public static class DatabaseSeedInitializer
    {
        public static IHost Seed(this IHost host)
        {
            using (var scope = host.Services.CreateScope())
            {
                ...
                try
                {
                    var context = serviceProvider.GetRequiredService<ChallengerContext>();
                    ...
                    if (!context.Users.Any())
                    {
                        ...
                        if (!context.TournamentCategories.Any())
                        {
                ...
                {
                    Console.WriteLine("Error creating database or seed data.", ex);
                }
            }
            return host;
        }
